...
export default function TechWaiting({setOption,cars,userIn }){
  ...
  return editMode==="ND"?(<Container justify="center">
    <Grid.Container gap={0.5} >
      ...
      <Text size="$md" color="white">En attente de réception </Text>
      </Grid>
    ...
    <Grid.Container gap={0.5} >
      <Grid xs={24} justify="center">
      <Text size="$md" color="white"> Nouveaux </Text>
      </Grid>
      <Grid.Container gap={2} justify="flex-start">
  ...
  </Container>):(<CarCardTechEditMode editMode={editMode} setOption={setOption} userIn={userIn} setEditMode={setEditMode} ></CarCardTechEditMode>);
};
